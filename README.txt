...
Installation
    1. Clone from git: "git clone https://github.com/UVU-CS2450-Software-Engineering/UVSIM.git"

Running UVSim
    1. Navigate to the cloned GitHub repository.
    2.  a) Linux/Mac
            From the terminal execute: "python3 -m UVSim"
        b) Windows
            From CMD Prompt/Powershell execute: "python -m UVSim"
    2. When prompted, supply the file path to the desired program.
    3. Enter a value each if/when prompted.
