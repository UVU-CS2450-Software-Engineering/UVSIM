...
from UVSim.BRANCHZERO import branchzero
...
def test_branchzero():
    ...
    my_instr: str = "+4209"
    my_inst: instruction = branchzero(instr=my_instr)
    ...
    def test_branchzero_errors():
        ...
        with pytest.raises(Exception):
            my_instruction: instruction = branchzero("+3000")
